...
import ru.letu.ui.helpers.utils.testdata.Deeplink.DEEPLINK_M_PAYMENT_INFO
import ru.letu.ui.screens.PaymentTypesScreen

class DeeplinkMPaymentsInfoTest : DefaultTest(
    ...
    override val runSteps: TestContext<Unit>.() -> Unit = {
        step("Проверка Deeplinks. Способы оплаты") {
            featureRouter.open(DEEPLINK_M_PAYMENT_INFO)
